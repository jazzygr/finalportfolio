    ...
    <div className="container">
      <div className="textContainer">
        <div className="lineContainer">
          ...
          <h1 data-aos-delay="1200" data-aos="fade-up" data-aos-easing="ease-out">My name's Jeff</h1>
          <h2 data-aos="fade-right" data-aos-delay="2000" data-aos-easing="ease-in-out">I build <span>websites.</span></h2>
          <div
          data-aos-delay="3000" data-aos="fade-in" data-aos-once="true" data-aos-offset="-100"
